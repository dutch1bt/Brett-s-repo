...
function RegisterForm() {
  ...
  const hasCode = !!form.invite_code;
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12"
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-green-400 mt-2 text-sm font-medium tracking-wide uppercase">Join the Group</p>
      </div>
      ...
      <div className="w-full max-w-sm">
        <div className="bg-green-900/50 backdrop-blur-sm border border-green-700/50 rounded-3xl p-8 shadow-2xl">
          ...
          {!hasCode && (
            <div className="mb-5 px-4 py-3 rounded-xl bg-amber-900/30 border border-amber-700/40 text-amber-300 text-sm text-center">
              You need an invite link from Brett to join.
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Invite code — pre-filled from URL, hidden if present */}
            {!hasCode && (
              <div>
                <label className="block text-green-300 text-xs font-semibold uppercase tracking-wide mb-1.5">
                  Invite Code
                ...
                <input
                  ...
                  className="input"
                  placeholder="Ask Brett for this"
                />
              </div>
            )}
